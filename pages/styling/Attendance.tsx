                ...
                <div className="flex items-center gap-4">
                    {canEdit && (
                        <>
                            ...
                            <button
                                ...
                                disabled={isSaving}
                                className="flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 shadow-md shadow-red-200 transition font-medium text-sm disabled:bg-slate-300 disabled:cursor-not-allowed"
                            >
                                <Trash2 size={16} /> 一键清除
                            </button>
                        </>
                    ...
                    <div className="flex items-center gap-4 bg-white p-2 rounded-lg border border-slate-200 shadow-sm">
                        <div className="flex items-center gap-2">
                            <label htmlFor="attendance-year" className="text-sm font-bold text-slate-600">年份</label>
                            <select
                                id="attendance-year"
                        ...
                        <div className="flex items-center gap-2">
                            <label htmlFor="attendance-month" className="text-sm font-bold text-slate-600">月份</label>
                            <select
                                id="attendance-month"
                                className="border border-slate-300 rounded-md px-2 py-1 text-sm bg-slate-50 focus:ring-2 focus:ring-accent outline-none"
